var cardInfo = (function (){
    ...
    let deleteCard = function () {
        let currentCard = document.querySelector(".card-item");
    ...
    return {
        ...
        cardSense:cardSense,
        toggleShowHideAnswer:toggleShowHideAnswer,
