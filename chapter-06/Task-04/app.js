...
function addTask(e) {
  if (taskInput.value === "") {
    ...
    // Add class
    iTime.className = "fas fa-trash text-danger ml-auto delete-item";
    // Append the i to li
    ...
    // Add class
    iPen.className = "fas fa-check text-primary ml-2 check-item";
    // Append the i to li
    li.appendChild(iPen); 
...
function doneTask(e) {
  if (e.target.classList.contains("check-item")) {
    ...
    e.target.className = "fas fa-check-double text-primary ml-2 doubleCheck-item";
